...
public class EncryptDecrypt {
	...
	/**
	 * The constructor does most of the work. It initializes all final variables and
	 * invoke two methods for encryption and decryption job. After successful job
	 * the constructor puts the decrypted password in variable to be retrieved by
	 * calling class.
	 * 
	 * 
	 * @param pPropertyFileName       /Name of the properties file that contains the
	 *                                password
	 * @param pUserPasswordKey        /Left hand side of the password property as
	 *                                key.
	 * @param pIsPasswordEncryptedKey /Key in the properties file that will tell us
	 *                                if the password is already encrypted or not
	 * 
	 * @throws Exception
	 */
	public EncryptDecrypt(String pPropertyFileName, String pUserPasswordKey, String pIsPasswordEncryptedKey)
			throws Exception {
	...
	private void encryptPropertyValue() throws ConfigurationException {
		...
		// Retrieve boolean properties value to see if password is already encrypted or
		// not
		...
		if (isEncrypted.equals("false")) {
			...
			// Apache Commons Cinfiguration library
